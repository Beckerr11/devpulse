...
const mvp = [
  "Dashboard semanal de atividade tecnica com foco em fluxo.",
  "Alertas de gargalo em PR, issue e deploy.",
  "Objetivos de produtividade com historico de evolucao.",
  "Resumo semanal para acompanhamento de time."
];
const hero = "https://picsum.photos/seed/devpulse-hero/1920/1080";
  ...
  return (
    <div className="page">
      <header className="hero full-bleed" style={{ "--hero": `url(${hero})` } as CSSProperties}>
        <nav className="nav"><p className="brand">DevPulse</p><a className="btn btn-ghost" href="#mvp">MVP</a></nav>
        <div className="hero-content">
          <p className="eyebrow">analytics</p>
          <h1>Painel operacional de performance para desenvolvedores e squads.</h1>
          <p className="lead">Times de engenharia trabalham com sinais dispersos sem um cockpit unico para priorizar melhoria continua.</p>
      ...
      <main className="shell">
        ...
        <section className="section split" data-reveal>
          ...
          <article><p className="label">Produto</p><h2>Assinatura mensal por usuario com plano free para dev individual.</h2><p className="lead" style={{ color: "var(--muted)" }}>Base pronta para evoluir com autenticacao, banco e analytics.</p></article>
        </section>
      ...
      <footer className="footer"><p>DevPulse</p><p>{new Date().getFullYear()} - Projeto com padrao senior.</p></footer>
    </div>
  );
}
