...
const profileDefaults = {
  ...
  "name": "DevPulse",
  "slug": "devpulse",
  "tagline": "Cockpit de produtividade para squads com sinais acionaveis.",
  "vertical": "engineering-analytics",
  "entity": {
    "singular": "sinal",
    "plural": "sinais"
  },
  "copy": {
    "titleLabel": "Titulo do sinal",
    "detailsLabel": "Descricao do gargalo",
    "createButton": "Registrar sinal",
    "workspaceTitle": "Painel de sinais de produtividade",
    "workspaceDescription": "Visualize bloqueios reais para melhorar fluxo de entrega do squad."
  },
  "mvp": [
    "Registro de sinais de desempenho tecnico por sprint.",
    "Painel para tratar gargalos de entrega rapidamente.",
    "Filtro operacional para focar no que bloqueia o time.",
    "Indicadores de fluxo para decisao semanal."
  ],
  "workflow": [
    "Criar sinal de risco com evidencias do time.",
    "Definir prioridade e responsavel da acao corretiva.",
    "Concluir acao e medir efeito no proximo ciclo."
  ],
  "seedItems": [
    {
      "title": "Fila de PR acumulada acima do esperado",
      "details": "Tempo medio de revisao subiu para 19 horas nas ultimas 2 semanas.",
      "priority": "high",
      "status": "open"
    },
    {
      "title": "Instabilidade nos testes de integracao",
      "details": "Suite de pagamentos falhou em 4 pipelines consecutivos sem alteracao funcional.",
      "priority": "medium",
      "status": "open"
    },
    {
      "title": "Baixa cobertura em modulo legado",
      "details": "Cobertura aumentou para 62 por cento apos refatoracao da camada de servico.",
      "priority": "low",
      "status": "done"
    }
  ]
